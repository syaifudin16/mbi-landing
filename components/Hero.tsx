...
import HeroImage from "@/assets/images/pengasuh.png";
      ...
      <div className="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
        <div>
          <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">
            Raih Kesuksesan Anda Bersama
            <span className="text-emerald-600"> MBI!</span>
          </h1>
          <p className="mt-3 text-lg text-gray-800">
            Gabung di Madrasah Bertaraf Internasional Paling Unggul di Indonesia
            dan wujudkan impian akademis serta karir global Anda sekarang juga!
          </p>

          <div className="mt-7 grid w-full gap-3 sm:inline-flex">
            <a
              className="inline-flex items-center justify-center gap-x-2 rounded-lg border border-transparent bg-emerald-600 px-4 py-3 text-sm font-medium text-white hover:bg-emerald-700 focus:bg-emerald-700 focus:outline-none disabled:pointer-events-none disabled:opacity-50"
          ...
          <div className="mt-6 grid grid-cols-2 gap-x-5 lg:mt-10">
            <div className="py-5">
              ...
              <p className="mt-3 text-sm text-gray-800">
                <span className="font-bold">4.6</span> /5 - dari 1k++ ulasan
              </p>
            ...
            <div className="py-5">
              <div className="flex flex-col">
                <span className="text-2xl font-bold">17 Tahun Pengalaman</span>
                Sistem Pendidikan Bertaraf Internasional
              </div>
            </div>

            <div className="py-5">
              <div className="flex flex-col">
                <span className="text-2xl font-bold">100% Lulusan</span>
            ...
            <div className="py-5">
              <div className="flex flex-col">
                <span className="text-2xl font-bold">3 Kurikulum</span>
                Kurikulum Merdeka, Muadalah Al-Ahzar University, dan
        ...
        <div className="relative ms-4">
          <div className="absolute bottom-0 right-0 z-10 p-4 text-right">
            <div className="rounded-md bg-emerald-100 p-2">
              <div className="flex flex-col items-start">
                ...
                <div className="text-sm font-medium text-gray-800">
                  Pendiri & Pengasuh PP. Amanatul Ummah
                </div>
              </div>
            </div>
          </div>
          <Image
            ...
            height={500}
            src={HeroImage}
            className="w-full scale-x-[-1] transform rounded-md"
            alt="Hero"
          />
          <div className="absolute inset-0 -z-[1] -mb-4 -ms-4 me-4 mt-4 size-full rounded-md bg-gradient-to-tr from-emerald-200 via-white/0 to-white/0 lg:-mb-6 lg:-ms-6 lg:me-6 lg:mt-6"></div>
        </div>
      </div>
    </div>
  );
