export default function PrivacyApps() {
  return (
    <main id="content">
      ...
      <div className="md:max-w-screen-sm lg:max-w-[992px] px-4 sm:px-6 lg:px-8 pb-12 md:pt-6 sm:pb-20 mx-auto">
        <div className="grid gap-4 md:gap-8">
          <p>
            MBI AMANATUL UMMAH built the MBI AMANATUL UMMAH app as a Free app.
            This SERVICE is provided by Software Sekolah at no cost and is
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at MBI AMANATUL UMMAH
          ...
          <h2 className="text-xl font-semibold mb-2">Google Play Services</h2>
          ...
          <h2 className="text-lg font-semibold mb-2">Links to Other Sites</h2>
          <p className="mb-5">
